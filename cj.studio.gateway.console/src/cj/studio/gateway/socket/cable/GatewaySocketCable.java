...
public class GatewaySocketCable implements IGatewaySocketCable, IServiceProvider {
	...
	private void parseConnStr(String connStr) {
		...
		this.readTimeout = StringUtil.isEmpty(f.parameter("readTimeout")) ? 2147483000L/*10000L*/
				: Long.valueOf(f.parameter("readTimeout"));
		this.writeTimeout = StringUtil.isEmpty(f.parameter("writeTimeout")) ? 2147483000L/*10000L*/
