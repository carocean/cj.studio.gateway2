package cj.studio.gateway.tools.sc;
...
@CjService(name = "serversConsole")
public class ServersConsole extends Console  {
	...
	protected String prefix(IGateway gateway, Object... target) {
		return ServersConsole.COLOR_CMDPREV +"sc>"
				+ ServersConsole.COLOR_CMDLINE;
	}
	@Override
