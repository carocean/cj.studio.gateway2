...
import cj.studio.gateway.server.handler.HttpServerHandler;
...
public class HttpServerInitializer extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		String aggregatorstr = info.getProps().get("Aggregator-Limit");// 最大聚合的内容大小，一般用于限制文件最大大小的上传
...
//	        cp.addLast(new WebSocketFrameAggregator(aggregator));
		...
		HttpServerHandler handler = new HttpServerHandler(parent);
