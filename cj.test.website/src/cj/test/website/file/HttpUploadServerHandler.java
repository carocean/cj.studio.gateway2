...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    public void messageReceived(ChannelHandlerContext ctx, HttpObject msg) throws Exception {
        ...
        if (decoder != null) {
            ...
            if (msg instanceof HttpContent) {
                ...
                if(chunk instanceof DefaultHttpContent) {
                	DefaultHttpContent cnt=(DefaultHttpContent)chunk;
                	cnt.content().resetReaderIndex();
                	byte[] b=new byte[cnt.content().readableBytes()];
                	cnt.content().readBytes(b);
    ...
    private void writeResponse(Channel channel) {
        ...
        // Build the response object.DefaultFullHttpResponse是包含lastContent的
